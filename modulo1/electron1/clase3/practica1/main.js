...
//dialog.showErrorBox
("Error de inicio", "Ha ocurrido un error al leer el archivo config.json")
    //app.exit
    ();
let ventana;
...
","Index.html"],
    ...
    switch (resp) {
        case 0: abrirVentanaCadif1();
            break;
        case 1: new BrowserWindow().loadURL("
http://google.com
            ");
        break;
...
http://cadif1.com
    ...
    ventana.on("ready-to-show", () => {
            console.log("esta listo el contenido de 
cadif1.com
")
